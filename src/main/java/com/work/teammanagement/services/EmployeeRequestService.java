...
public final class EmployeeRequestService {
    public static void planHoliday(String startDate, String endDate, String requestText, String managerUserName) throws UserNotFoundException, NotLoggedInAsEmployeeException, UserNotLoggedInException, NotManagerException {
        EmployeeRequestsDB.addRequest("Vacation: " + startDate + "-" + endDate, requestText, managerUserName);
    }

    public static void requestWorkFromHome(String startDate, String endDate, String requestText, String managerUserName) throws UserNotFoundException, NotLoggedInAsEmployeeException, UserNotLoggedInException, NotManagerException {
        EmployeeRequestsDB.addRequest("Work from home: " + startDate + "-" + endDate, requestText, managerUserName);
    }

    public static void requestShortTimeAbsence(String date, String requestText, String managerUserName) throws UserNotFoundException, NotLoggedInAsEmployeeException, UserNotLoggedInException, NotManagerException {
